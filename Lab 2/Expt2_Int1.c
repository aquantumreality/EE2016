 ...
 * Aim: C-interfacing of LED blinking IN PB0 10 times (ON(or OFF) = 1 sec, duty cycle is 50%) in a ATMega8A device using External Interrupt Request 1
...
int main(void)
{
	...
	GICR=0x80;   //Enable external interrupt 1
	PORTB=0x00;
